...
Route::post('/submit-order', function()
{
	...
	return Redirect::to('order-details/' . $gencode)->with('message', 'ยืนยันการสั่งซื้อเรียบร้อย หากทำการโอนเงินแล้วยืนยันการโองเงินด้านล่าง <b>หากต้องการยืนยันภายหลัง ให้ไปที่หน้าค้นหาแล้วพิมพ์รหัสการสั่งซื้อลงไปเมื่อท่านต้องการยืนยัน</b><h3 class="text-center">โปรดจำรหัสการสั่งซื้อของท่าน Order Code : <b>'. $gencode .'</b></h3> ');
