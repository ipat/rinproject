<html>
	<head>
        ...
        <title>ยืนยันการโอนเงิน | Rin Website</title>
        <?php $order = DB::table('order')->where('order_code', "RIN3703")->first(); ?>
	</head>
	<body>

		<div class="col-md-8 col-md-offset-2">
			<a href="<?php echo $url; ?>/list"><h4><i class="fa fa-angle-left"></i> กลับไปซื้อสินค้า</h4></a>
			<div class="page-header"><h1>ยืนยันการโอนเงิน</h1></div>
			<?php if($errors->has()): ?>
			...
			<form action="" method="POST" class="form-horizontal">
				<div class="form-group row">
					...
					<div class="col-md-6">
						<input type="text" id="order-id" name="order_code" class="form-control" placeholder="RINXXXX">	
					</div>
					<div class="check-order"></div>
				</div>
				<div class="slide-data col-md-6 col-md-offset-3">
				...
				<div class="slide-form col-md-6 col-md-offset-3">
